...
/**
 * Security Configuration for Vehicles Microservice
 * 
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors(cors -> cors.configurationSource(corsConfigurationSource()))
                ...
                .authorizeHttpRequests(authz -> authz
                        ...
                        .requestMatchers("/vehicles/actuator/**").permitAll()
                        .requestMatchers("/api-docs/**").permitAll()
                        .requestMatchers("/vehicles/api-docs/**").permitAll()
                        .requestMatchers("/swagger-ui/**").permitAll()
                        .requestMatchers("/vehicles/swagger-ui/**").permitAll()
                        ...
                        // User endpoints (requires authentication) - users can manage their own
                        // vehicles
                        .requestMatchers("/api/v1/vehicles/**").hasAnyRole("USER", "ADMIN")
